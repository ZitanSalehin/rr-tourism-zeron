  ...
  return (
    <section className="relative bg-gray-100 shadow-md overflow-hidden">
      ...
      <div className="relative mx-auto min-h-[550px] lg:min-h-[700px] flex flex-col md:flex-row">
        ...
        ></div>
        {/* Right HALF (50%) */}
        <div className="relative flex flex-col justify-center items-start px-6 py-12 text-gray-800 w-full md:w-1/2">
          {/* Hill image bottom-left */}
          <div>
            <img
              src={hill}
              alt="hill"
              className="absolute bottom-0 right-0 w-36 md:w-130 z-1 opacity-30 transform scale-x-[-1]"
            />
          </div>
