...
const testimonials = [
  {
    id: 1,
    text: "Qemo enim ipsam voluptatem quia voluptas sit asperna aut odit aut fugit...",
    name: "Alice",
    title: "Happy Client",
    image: sixtySix,
  },
  {
    id: 2,
    text: "Nemo enim ipsam voluptatem quia voluptas sit asperna aut odit aut fugit...",
    name: "Kevin James",
    title: "Happy Client",
    image: sixtySix,
  },
  {
    id: 3,
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, perferendis...",
    name: "Jessica Miller",
    title: "Happy Client",
    image: sixtySix,
  },
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28 lg:py-32 flex flex-col md:flex-row items-center gap-16 md:gap-24 lg:gap-40">
        ...
        <div className="w-full md:w-1/2 text-gray-800">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl playfair font-semibold leading-snug text-center lg:text-start">
