...
export default function DestinationTabs() {
  ...
  return (
    <section className="py-10 lg:py-16 container mx-auto max-w-7xl px-5 lg:px-20">
      ...
      {/* TAB BUTTONS */}
      <div className="flex justify-center gap-4 mb-10 border-b-2 border-gray-200 mx-80">
        {tabs.map((tab) => (
          <button
            key={tab}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredData.map((item, i) => (
          <div
            key={i}
            className="mx-auto bg-gray-50 rounded-3xl p-4 border border-white hover:border-[#E55E46] transition-all duration-300"
          >
            {/* IMAGE BOX */}
